...
import { MetadataFieldWrapperDlComponent } from './metadata-field-wrapper-description-list.component';
...
describe('MetadataFieldWrapperDlComponent', () => {
  let component: MetadataFieldWrapperDlComponent;
  let fixture: ComponentFixture<MetadataFieldWrapperDlComponent>;

  beforeEach(waitForAsync(() => {
    TestBed.configureTestingModule({
      declarations: [MetadataFieldWrapperDlComponent, NoContentComponent, SpanContentComponent, TextContentComponent]
    }).compileComponents();
  }));

  beforeEach(() => {
    fixture = TestBed.createComponent(MetadataFieldWrapperDlComponent);
