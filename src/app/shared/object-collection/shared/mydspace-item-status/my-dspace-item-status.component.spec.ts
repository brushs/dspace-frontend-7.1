...
describe('MyDSpaceItemStatusComponent', () => {
  ...
  it('should init badge content and class', () => {
    ...
    expect(component.badgeClass).toBe('badge badge-warning');
  });
  ...
  it('should init badge content and class', () => {
    ...
    expect(component.badgeClass).toBe('badge badge-info');
  });
  ...
  it('should init badge content and class', () => {
    ...
    expect(component.badgeClass).toBe('badge badge-primary');
  });
