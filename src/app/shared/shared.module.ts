...
import { MetadataFieldWrapperDlComponent } from '../item-page/field-components/metadata-field-wrapper-description-list/metadata-field-wrapper-description-list.component';
...
const SHARED_ITEM_PAGE_COMPONENTS = [
  ...
  MetadataFieldWrapperDlComponent,
